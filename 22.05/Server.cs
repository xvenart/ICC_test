...
namespace TankServer
{
    public class Server : IDisposable
    {
                    ...
                    lock (_syncObject)
                    {
                        ...
                        else
                        {
                            ...
                            if (response.ClientCommand == ClientCommandType.Login)
                            {
                                ...
                                clientInfo.Request = new ServerRequest
                                {
                                    IsSettingsChanged = true,
                                    Settings = tankSettings
                                };
        ...
        public BaseInteractObject AddTankBot(string nickname, string tag)
        {
            ...
            var tank = new TankObject(Guid.NewGuid(), rectangle, Settings.TankSpeed, false, 100, 100, 5, 5, nickname, tag, Settings.TankDamage);
        ...
        protected async Task SendUpdates(bool onlySpectators, CancellationToken cancellationToken)
        {
            ...
            foreach (var client in clientsCopy)
            {
                ...
                var request = new ServerRequest
                {
                    ...
                    Settings = IsSettingsChanged ? Settings : null
                };
