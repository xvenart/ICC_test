...
namespace TankServer
{
    public class Server : IDisposable
    {
            ...
            _socketServer.Start(socket =>
            {
                socket.OnOpen = () =>
                {
                    lock (_syncObject)
                    {
                        ...
                        Clients.Add(socket, new ClientInfo() { NeedUpdateSettings = true, Request = new ServerRequest { Settings = Settings } });
                    }
                };
                socket.OnClose = () =>
                {
                ...
                socket.OnMessage = msg =>
                {
                    lock (_syncObject)
                    {
                        ...
                        else
                        {
                            ...
                            if (response.ClientCommand == ClientCommandType.Fire)
                            {
                                Settings.UpdateGameSpeed(4);
                            }
        ...
        public BaseInteractObject AddTankBot(string nickname, string tag)
        {
            ...
            var tank = new TankObject(Guid.NewGuid(), rectangle, Settings.TankSpeed, false, 100, 100, Settings.CountOfLife, 5, nickname, tag, Settings.TankDamage);
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        protected async Task SendUpdates(bool onlySpectators, CancellationToken cancellationToken)
        {
            ...
            foreach (var client in clientsCopy)
            {
                ...
                client.Value.NeedUpdateSettings = Settings.IsSettingsChanged;
                ...
                var request = new ServerRequest
                {
                    ...
                    Settings = client.Value.NeedUpdateSettings ? Settings : null
                };
                ...
                if (Settings.IsSettingsChanged)
                {
                    ...
                    Settings.IsSettingsChanged = false;
                }
            }
        }
