                            ...
                            while (speed >= 0)
                            {
                                ...
                                if (canMove)
                                {
                                    ...
                                    if (movingObject is BulletObject bulletObject)
                                    {
                                        ...
                                        if (Settings.GameSpeed != GetSettings().GameSpeed || Settings.GameSpeed != 1 || Settings.BulletSpeed != GetSettings().BulletSpeed)
                                        {
                                    ...
                                    else if (movingObject is TankObject tankObject)
                                    {
                                        ...
                                        if (Settings.GameSpeed != GetSettings().GameSpeed || Settings.TankSpeed != GetSettings().TankSpeed || Settings.GameSpeed != 1)
                                        {
                                        ...
                                        if (intersectedObject is UpgradeInteractObject upgradeObject)
                                        {
                                            ...
                                            if (Settings.TankDamage != GetSettings().TankDamage || tank.Damage != Settings.TankDamage)
                                            {
