...
namespace TankClient
{
    public class TestClient : IClientBot
    {
        ...
        public ClientCommandType GoToTarget()
        {
            ...
            else if (Step.X == Tank.LeftInt - 1 && Step.Y == Tank.TopInt)
            {
                if (Request.Tank.Direction != DirectionType.Left && LocationMap[(int)Step.X, (int)Step.Y] != -1)
                {
                    return ClientCommandType.TurnLeft;
                }
                else
            ...
            else if (Step.X == Tank.LeftInt && Step.Y == Tank.TopInt + 1)
            {
                if (Request.Tank.Direction != DirectionType.Down && LocationMap[(int)Step.X, (int)Step.Y] != -1)
                {
                    return ClientCommandType.TurnDown;
                }
                else
            ...
            {
                if (Request.Tank.Direction != DirectionType.Up && LocationMap[(int)Step.X, (int)Step.Y] != -1)
                {
                    return ClientCommandType.TurnUp;
                }
                else
